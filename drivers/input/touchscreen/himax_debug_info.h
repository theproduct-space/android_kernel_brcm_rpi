#ifndef H_HIMAX_DEBUG_INFO
#define H_HIMAX_DEBUG_INFO
...
HX_TAB "echo " DBG_REG_NAME ",[WriteSlave],[ReadSlave],r:x > debug\n"\
HX_TAB "echo " DBG_REG_NAME ",[WriteSlave],[ReadSlave],w:x:x > debug\n"
...
HX_TAB "1 : hw reset\n"\
HX_TAB "2 : sw reset\n"\
HX_TAB "3 : leave safe mode\n"\
HX_TAB "4 : sense on\n"\
HX_TAB "lo : reset pin keep low\n"\
HX_TAB "hi : reset pin keep high\n"\
...
HX_TAB "echo [flash/dsram/isram],[print/file],[size],[address] > flash_dump\n"\
