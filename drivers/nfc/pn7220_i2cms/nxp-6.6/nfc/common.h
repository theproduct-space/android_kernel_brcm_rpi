...
#define SMCU_FW_DNLD_TRIGGERED   _IOW(NFC_MAGIC, 0x07, uint32_t)
...
struct nfc_dev {
	...
	wait_queue_head_t smcu_fw_dnld_wq;
	...
	bool smcu_irq_enabled;
	spinlock_t smcu_irq_enabled_lock;
	bool smcu_fw_dnld_triggered;
